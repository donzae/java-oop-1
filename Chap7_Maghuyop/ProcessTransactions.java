...
public class ProcessTransactions {
	public static void main(String[] args) {
		...
		System.out.println("Transaction Summary of the day:");

		// Print number of deposits
		System.out.println("Number of deposits: " + acct1.getNumDeposits());

		// Print number of withdrawals
		System.out.println("Number of withdrawals: " + acct1.getNumWithdrawals());

		// Print total amount of deposits
		System.out.println("Total amount of deposits: " + acct1.getTotalDeposits());
